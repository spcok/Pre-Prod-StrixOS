              ...
              {(field) => (
                <div className="space-y-1">
                  ...
                  <select
                    ...
                    className="w-full px-3 py-3 border border-slate-200 rounded-lg text-sm font-bold text-slate-800 focus:ring-2 focus:ring-orange-500 outline-none bg-white"
                  >
