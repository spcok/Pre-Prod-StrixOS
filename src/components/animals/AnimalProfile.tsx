...
import { 
  ...
  ThermometerSun, Droplets, MapPin, GitMerge, Presentation
} from 'lucide-react';
        ...
        <div className="bg-white rounded-3xl p-5 flex flex-col md:flex-row gap-8 shadow-2xl">
          ...
          <div className="flex-1 flex flex-col pt-2 relative">
            <div className="absolute top-0 right-0 flex items-center gap-2">
              ...
              <button className="p-2.5 text-rose-600 border border-slate-200 rounded-xl hover:bg-rose-50 hover:border-rose-200 transition-all shadow-sm bg-white" title="Archive Record">
                <Archive size={16} />
              </button>
              {handleClose && (
